package  
{
	...
	public class Splash extends Entity
	{
		 ...
		 * Embedded graphics.
		 */
		[Embed(source="../assets/splash/splash_lines.png")] private const SPLASH_LINES:Class;
		[Embed(source="../assets/splash/splash_cog.png")] private const SPLASH_COG:Class;
		[Embed(source="../assets/splash/splash_left.png")] private const SPLASH_LEFT:Class;
		[Embed(source="../assets/splash/splash_right.png")] private const SPLASH_RIGHT:Class;
